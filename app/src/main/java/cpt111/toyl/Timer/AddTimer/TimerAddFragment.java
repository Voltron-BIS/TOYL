...
public class TimerAddFragment extends Fragment implements TimerLengthDialog.OnInputSelected, TimerSelectTypeDialog.OnInputSelected{
    ...
    public void saveCompoundTimer() {
        ...
        if(validData()){
            ...
            CompoundTimer toAdd = new CompoundTimer(timerName.getText().toString(), isCountDown, parseInt(repetitions.getText().toString()), listOfTimersToAdd);
    ...
    public void sendInput(String name, long length) {
        ...
        listOfTimersToAdd.add(new Timer(name, length));
    }

    @Override
    public void setType(boolean isCountDown) {
