        ...
        saveTimer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(timerName.getText())) {
                    getTargetFragment().onActivityResult(getTargetRequestCode(), Activity.RESULT_CANCELED, replyIntent);
                } else {
                    String name = timerName.getText().toString();
                    replyIntent.putExtra(EXTRA_REPLY, name);

                    getTargetFragment().onActivityResult(getTargetRequestCode(), Activity.RESULT_OK, replyIntent);
